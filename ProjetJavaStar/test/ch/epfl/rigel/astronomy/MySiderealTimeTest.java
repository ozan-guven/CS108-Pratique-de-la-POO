...
class MySiderealTimeTest {
    ...
    void greenwichWorksOnGivenExample() {
        ...
        assertEquals(1.2220619247737088, SiderealTime.greenwich(of(1980,4,22,14,36,51,67, ZoneId.of("UTC"))));
        assertEquals(1.2221107819499082 , SiderealTime.greenwich(ZonedDateTime.of(1980,4,22,14,36,51,(int)67e7, ZoneOffset.UTC)));
        assertEquals(5.355270290366605  , SiderealTime.greenwich(of(2001,1,27, 12, 0 , 0,0, ZoneId.of("UTC"))));
        assertEquals(2.9257399567031235   , SiderealTime.greenwich(of(2004,9,23, 11,0,0,0,ZoneId.of("UTC"))));
    ...
    void localWorksOnGivenExample() {
        ...
        assertEquals(1.74570958832716, SiderealTime.local(ZonedDateTime.of(1980,4,22,14,36,51,27,ZoneOffset.UTC), GeographicCoordinates.ofDeg(30,45)));
    }

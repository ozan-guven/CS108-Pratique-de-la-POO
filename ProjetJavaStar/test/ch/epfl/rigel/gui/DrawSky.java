...
public final class DrawSky extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        painter.clear(sky, false);
        painter.drawStars(sky, projection, planeToCanvas, true, false);
        painter.drawPlanets(sky, projection, planeToCanvas, false); //Draws the planets

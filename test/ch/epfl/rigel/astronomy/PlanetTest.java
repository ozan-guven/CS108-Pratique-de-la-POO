...
//    }
    ...
    void planetNameIsCorrect() {
        ...
        for (int i = 0; i < TestRandomizer.RANDOM_ITERATIONS; i++) {
            ...
            var p = new Planet(planetName, equ, 0, 0, null);
    ...
    void planetAngularSizeIsCorrect() {
        ...
        for (int i = 0; i < TestRandomizer.RANDOM_ITERATIONS; i++) {
            ...
            var p = new Planet("Planet B", equ, angularSize, 0, null);
    ...
    void planetMagnitudeIsCorrect() {
        ...
        for (int i = 0; i < TestRandomizer.RANDOM_ITERATIONS; i++) {
            ...
            var p = new Planet("Planet B", equ, 0, magnitude, null);
    ...
    void planetEquatorialPosIsCorrect() {
        ...
        for (int i = 0; i < TestRandomizer.RANDOM_ITERATIONS; i++) {
            ...
            var p = new Planet("Planet B", equ, 0, 0, null);
